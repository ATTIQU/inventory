...
Route::controller(AdminController::class)->group(function () {
    ...
    Route::get('/admin/settings', 'settings')->name('admin.profile');
    Route::get('/edit/settings', 'Editsettings')->name('edit.settings');
    Route::post('/store/profile', 'StoreProfile')->name('store.profile');
    Route::post('/store/settings', 'StoreSetting')->name('store.settings');
