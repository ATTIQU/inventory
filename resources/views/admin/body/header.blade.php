                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="{{ url('/dashboard') }}" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{ asset('backend/assets/images/logo-light.png') }}" alt="logo-light-light" height="22">
                                </span>
                                <span class="logo-lg">
...
<div class="d-flex">
    ...
    <div class="dropdown d-inline-block user-dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            ...
            <a class="dropdown-item d-block" href="{{ route('edit.settings') }}"><i class="ri-settings-2-line align-middle me-1"></i> Settings</a>
