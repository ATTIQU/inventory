        ...
        <div class="card-body">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="copyright" class="form-control" type="text" value="{{ $editData->copyright }}"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
       ...
       <input name="logo" class="form-control" type="file"  id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($editData->logo))? url('upload/admin_images/'.$editData->logo):url('upload/no_image.jpg') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
